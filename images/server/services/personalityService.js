...
class PersonalityService {
	...
	constructor() {
		...
		this.personalityConfigs = {
			Aggressive: {
				attack: { min: 65, points: 1 },
				height: { min: 8, points: 1 },
				clicks: { min: 25, max: 70, points: 1 },
				types: ["fire", "dragon", "fighting", "dark"],
				descriptions: ["fierce", "wild", "powerful", "dominant", "aggressive", "strong"],
			},
			Calm: {
				attack: { min: 45, max: 75, points: 1 },
				height: { min: 6, max: 14, points: 1 },
				speed: { min: 40, max: 70, points: 1 },
				clicks: { min: 15, max: 50, points: 1 },
				types: ["water", "psychic", "grass", "normal"],
				descriptions: ["peaceful", "gentle", "balanced", "harmonious", "tranquil", "calm"],
			},
			Anxious: {
				attack: { min: 30, max: 60, points: 1 },
				height: { min: 4, max: 11, points: 1 },
				speed: { min: 70, points: 1 },
				clicks: { min: 40, max: 80, points: 1 },
				types: ["ghost", "poison", "bug", "psychic"],
				descriptions: ["nervous", "jumpy", "restless", "uneasy", "cautious", "wary"],
			},
			Loyal: {
				attack: { min: 50, max: 85, points: 1 },
				height: { min: 7, max: 16, points: 1 },
				clicks: { min: 10, max: 35, points: 1 },
				types: ["normal", "fighting", "steel", "fairy"],
				descriptions: ["protective", "devoted", "faithful", "steadfast", "reliable", "loyal"],
			},
			Naive: {
				attack: { min: 35, max: 65, points: 1 },
				height: { min: 5, max: 10, points: 1 },
				clicks: { min: 20, max: 55, points: 1 },
				types: ["normal", "fairy", "electric"],
				descriptions: ["innocent", "playful", "curious", "friendly", "cheerful", "bright"],
			},
			Timid: {
				attack: { min: 25, max: 55, points: 1 },
				height: { min: 3, max: 9, points: 1 },
				speed: { min: 65, points: 1 },
				clicks: { min: 45, max: 90, points: 1 },
				types: ["psychic", "ghost", "fairy", "grass"],
				descriptions: ["shy", "timid", "bashful", "reserved", "quiet", "fearful"],
			},
		};
	}
